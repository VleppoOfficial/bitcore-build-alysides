...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-alysides/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-alysides -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-alysides -o bitcore-lib-alysides.js';
    }
